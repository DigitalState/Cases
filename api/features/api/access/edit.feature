...
Feature: Edit accesses
  ...
  Scenario: Edit an access
    ...
    And I send a "PUT" request to "/accesses/d09447da-0f24-4f14-8e85-36fb8b969b91" with body:
    """
    {
  ...
  Scenario: Edit an access's read-only properties
    ...
    And the JSON node "uuid" should be equal to the string "d09447da-0f24-4f14-8e85-36fb8b969b91"
