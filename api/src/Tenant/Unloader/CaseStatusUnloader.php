...
/**
 * Class CaseStatusUnloader
 */
final class CaseStatusUnloader implements Unloader
{
    /**
    ...
    {
        $builder = $this->entityManager->getRepository(CaseStatus::class)->createQueryBuilder('e');
        $builder
            ->delete()
